...
#        print(name, email, phone, adress)
#        if len(name) < 2 or len(email) < 4 or len(phone) < 10 or len(adress) < 3:
#            messages.error(request, "Please fill the form correctly")
#
#        else:
#            account = Account (name=name, email=email, phone=phone, adrerss=adress)
#            contact.save()
